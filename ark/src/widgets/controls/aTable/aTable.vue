...
.a-table-widget table thead tr th{ 
    border:1px solid #e6e6e6; 
...
.a-table-widget table tbody tr{
    background-color:#fff;
    text-align:center;
    line-height:20px;
}

.a-table-widget table tbody tr:nth-child(even){
    background-color:#f2f2f2;
}

.a-table-widget table tbody tr td{
    padding:5px 10px;
    font-size:14px;
...
.a-table-widget table tbody tr:hover,
.a-table-widget table tbody tr.lv-selected{
...
.a-table-sort .fa-caret-up{

}
.a-table-sort .fa-caret-down{
}
</style>